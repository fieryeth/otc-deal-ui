  ...
  return (
    <div className="mt-24 text-xl">
      {user0 ? (<div className="flex justify-between w-4/5 m-auto">
        ...
        <svg role="status" className="m-auto w-24 h-24 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
      ...
      {user0 && <div className="mt-8 text-center text-3xl">
      <p>User 1 needs to send {amount0.toNumber()} of Token 1.</p>
      <p>User 2 needs to send {amount1.toNumber()} of Token 2.</p>
      </div>}
    </div>
  );
};
